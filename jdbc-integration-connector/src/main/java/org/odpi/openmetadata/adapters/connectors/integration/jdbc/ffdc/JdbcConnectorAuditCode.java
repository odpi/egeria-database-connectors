...
public enum JdbcConnectorAuditCode implements AuditLogMessageSet {
    ...
    EXITING_ON_TRANSFER_FAIL("JDBC-INTEGRATION-CONNECTOR-0003",
            OMRSAuditLogRecordSeverity.INFO,
    ...
    EXITING_ON_METADATA_TRANSFER("JDBC-INTEGRATION-CONNECTOR-0007",
            OMRSAuditLogRecordSeverity.INFO,
    ...
    PARTIAL_TRANSFER_COMPLETE_FOR_DB_OBJECTS("JDBC-INTEGRATION-CONNECTOR-0009",
            ...
            "None"),
    ERROR_WHEN_REMOVING_ELEMENT_IN_OMAS("JDBC-INTEGRATION-CONNECTOR-0010",
            OMRSAuditLogRecordSeverity.INFO,
